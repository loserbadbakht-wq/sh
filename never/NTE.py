...
def get_latest(limit=50):
    ...
    params = {'limit': limit, 'pid': 0, 'tags': 'neverness_to_everness -ai-generated'}
...
<rss version="2.0">
<channel>
<title>NTE - RSS Feed</title>
<link>https://github.com</link>
<description>Latest NTE images from safebooru</description>
"""
...
try:
    ...
    filename = './never/NTE-rss.xml'
    with open(filename, 'w', encoding='utf-8') as f:
        f.write(generate_rss().strip())
    print('✅ RSS saved to ./never/NTR-rss.xml')
